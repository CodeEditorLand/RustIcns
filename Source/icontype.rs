...
impl IconType {
	...
	/// assert_eq!(IconType::from_pixel_size(48, 48), Some(IconType::RGB24_48x48));
	/// assert_eq!(IconType::from_pixel_size(256, 256), Some(IconType::RGBA32_256x256));
	/// assert_eq!(IconType::from_pixel_size(1024, 1024), Some(IconType::RGBA32_512x512_2x));
	/// ```
	...
	/// ```
	/// use tauri_icns::IconType;
	/// assert_eq!(IconType::from_pixel_size_and_density(48, 48, 1), Some(IconType::RGB24_48x48));
	/// assert_eq!(
	/// 	IconType::from_pixel_size_and_density(256, 256, 1),
	/// 	Some(IconType::RGBA32_256x256)
	/// );
	/// assert_eq!(
	/// 	IconType::from_pixel_size_and_density(256, 256, 2),
	...
	/// ```
	/// use tauri_icns::IconType;
	/// assert_eq!(IconType::RGB24_16x16.mask_type(), Some(IconType::Mask8_16x16));
	...
	/// ```
	pub fn pixel_width(self) -> u32 { self.screen_width() * self.pixel_density() }
	...
	/// ```
	pub fn pixel_height(self) -> u32 { self.screen_height() * self.pixel_density() }
